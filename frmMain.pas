        ...
        begin
                ...
                begin
                        ...
                        case iDrive of
                                ...
                                DRIVE_RAMDISK: lst.SubItems.Add('Dysk pamiÍciowy');
                        end;
...
begin
        ...
        begin
                ...
                begin
                        case iDrive of
                                ...
                                DRIVE_RAMDISK: sDrive := 'Dysk pamiÍciowy ';
                        end;
        ...
        mnu := TMenuItem.Create(pmList);
        mnu.Caption := 'Wyúwietl wszystkie dyski i napÍdy';
        mnu.Tag := 33;
        mnu.OnClick := DiskMenuClickHandler;
        pmList.Items.Add(mnu);
end;
...
begin
        ...
        if chbConfirmations.Checked then if Application.MessageBox(PChar('UruchomiÊ plik:'+chr(13)+sSelected+chr(13)+chr(13)+'Uruchomiony zostanie program skojarzony w systemie z typem wybranego pliku.'),'Uruchomienie pliku...',MB_YESNO+MB_ICONQUESTION+MB_DEFBUTTON2) = ID_NO then exit;
...
begin
        ...
        if not chbConfirmations.Checked then if Application.MessageBox('Gdy pole to jest odznaczone, przypadkowe naciúniÍcie klawisza Delete spowoduje usuniÍcie pliku bez potwierdzenia!'+chr(13)+'(Uwaga! Pliki sπ usuwane BEZ wykorzystania Kosza - jest to operacja NIEODWRACALNA!)'+chr(13)+''+chr(13)+'Czy na pewno wy≥πczyÊ ostrzeøenia?','Ostrzeøenie!',MB_YESNO+MB_ICONWARNING+MB_DEFBUTTON2) = ID_NO then chbConfirmations.Checked := True;
end;
...
begin
        ...
        begin
                ...
                sDest := InputBox('Zmiana nazwy', 'Podaj nowπ nazwÍ dla wskazanego pliku:', sSource);

                if sDest = sSource then exit;

                if not RenameFile(IncludeTrailingBackslash(cDirectory) + sSource, cDirectory + '\' + sDest) then
                        Application.MessageBox('Zmiana nazwy pliku nie powiod≥a siÍ!','B≥πd...',MB_OK+MB_ICONWARNING+MB_DEFBUTTON1)
                else
                        ReadDir(cDirectory, True);
        end;
        ...
        begin
                ...
                if chbconfirmations.Checked then if Application.MessageBox(PChar('Uwaga! Poniøszy plik zostanie TRWALE usuniÍty!' + chr(13) + chr(13) + sFile + chr(13) + chr(13) + 'Czy na pewno usunπÊ ten plik?' + chr(13) + '(Uwaga! Pliki sπ usuwane BEZ wykorzystania Kosza - jest to operacja NIEODWRACALNA!)'),'Usuwanie pliku...',MB_YESNO+MB_ICONQUESTION+MB_DEFBUTTON2) = ID_NO then exit;
                ...
                else Application.MessageBox('Usuwanie pliku nie powiod≥o siÍ!','B≥πd...',MB_OK+MB_ICONWARNING+MB_DEFBUTTON1)
        end;
...
begin
        ...
        begin
                Application.MessageBox('Nie wybrano øadnej pozycji na liúcie.','Informacja...',MB_OK+MB_ICONINFORMATION+MB_DEFBUTTON1);
                exit;
        end;
        ...
        begin
                Application.MessageBox('Wszystkie zaznaczone pozycje nie podlegajπ zmianie.','Informacja...',MB_OK+MB_ICONINFORMATION+MB_DEFBUTTON1);
                exit;
        end;
        ...
        if not AllDone then
        begin
                Application.MessageBox('Wystπpi≥ b≥πd przy zmianie nazwy jednego lub wiÍcej plikÛw albo folderÛw!' + #10#13 + 'ByÊ moøe posiadajπ one atrybut tylko-do-odczytu? ZmieÒ go i sprÛbuj ponownie.','Informacja...',MB_OK+MB_ICONEXCLAMATION+MB_DEFBUTTON1);
                exit;
        end;
